...
- [ ] Build setup: if java 21 is missing run brew install --cask temurin@21. Run ./gradlew build and fix any compile errors until green, checking calls against 1.21.11 yarn mappings.
      commit: fix build
